...
public class MenstruationCalculator {
    ...
    public static void main(String[] args) {
        MenstruationCalculator cal = new MenstruationCalculator();
        ...
        if (nextPeriod.equalsIgnoreCase("Yes")) {
            ...
            cal.setLastMenstrualFlow(date);
        }
        System.out.println("your next menstruation flow will start on " + cal.getNextMenstrualFlow());
